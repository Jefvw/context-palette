...
The authoritative repository instructions for AI coding assistants are in the root [AGENTS.md](../AGENTS.md). This page is intentionally short so two independent rule sets cannot drift.

Before changing code:

1. Follow the root agent instructions.
2. Use the [documentation index](README.md) to choose relevant references.
